...
**Contents:** [1 What is canon vs. proposed](#1-what-is-canon-vs-proposed) · [2 Timeline](#2-timeline) · [3 Port Angeles Harbor: open items resolved](#3-port-angeles-harbor-open-items-resolved) · [4 The crash and Grace's house](#4-the-crash-and-graces-house) · [5 Requirements for the group's lodging](#5-requirements-for-the-groups-lodging) · [6 ISS line of sight](#6-iss-line-of-sight) · [7 Winter clock](#7-winter-clock) · [8 Lodging options compared](#8-lodging-options-compared) · [9 Story hooks](#9-story-hooks-none-are-canon) · [10 Open questions](#10-open-questions) · [11 Sources](#11-sources)

---

## 1. What is canon vs. proposed
...
| **The group's base: the Coast Guard Air Station / Sector Field Office Port Angeles on Ediz Hook** (48.1408°N, 123.4108°W) | `[CANON]` (author, 2026-09-20) — see §8.2. Whether they also use nearby town homes is open (Q-24) |
| Rescue site moved from the Strait shoreline to the Elwha River near the crash | `[DERIVED]` proposal (§4.3) |
| **Catherine's surname is now Navarro** (was Reyes; collided with Sam's) | `[CANON]` working default (author, 2026-09-20); one prose edit in `sections/07` |
| **TruckHouse reasons:** (1) Catherine wants to know about her brother; (2) TruckHouse's BCRs are needed for the excursion to Italy to connect with Dr. Elise Marchetti | `[CANON]` (author, 2026-09-20). Not a safety relocation. The real TruckHouse BCR is confirmed — a vacuum-infused carbon-fiber monocoque camper, built with American Expedition Vehicles on a Ram 3500 Prospector XL `[SRC]` (expeditionportal.com, gearjunkie.com, autoevolution.com). **TruckHouse never publicly defines what the letters stand for** (same for their smaller "BCT" model) — resolved 2026-09-21: the book follows suit and never spells it out either |

---

## 2. Timeline

Day 0 = Tue Sept 5, 2028. Day numbering is relative per the craft rules; the calendar dates are for arithmetic only.
...
Section 9 puts the *Pacific Tender* "three days out" on Day 0. The prose (§9) says "**three days from Seattle**", but the cast bio says "three days out **of Yokohama**". Only the second reading gives the author's timeline.

| Assumption | Distance to Port Angeles after 3 days | Arrives |
|---|---|---|
| Great-circle Yokohama–Seattle ≈ 4,165 nm `[DERIVED]`; real routing typically 4,300–4,600 nm `[VERIFY]`; 17.5 kt | ~3,000 nm (about 3 d × 17.5 kt ≈ 1,260 nm already run; Port Angeles is ~70 nm short of Seattle) | **Day ~7** |
| Aggregator sea-route figure 5,300 nm, fastest ~12 d 14 h (≈ 17.5 kt avg) `[SRC]` (fluentcargo.com; `[VERIFY]` — this looks long for a great-circle-style routing) | ~3,970 nm | **Day ~9–10** |
| Slow steaming at ~15 kt on a ~4,500 nm route `[DERIVED]` | ~3,300 nm | **Day ~11** |

**Conclusion:** Day 9–10 is well inside the plausible range. It needs **one prose fix in Section 9**: "three days from Seattle" → "more than a week from Seattle" (or similar). It also means Section 10's "anchored the day before yesterday" on Day 5 has to move (D-17).

### 2.3 The stay `[CANON]` + `[SRC]`

| Milestone | When |
|---|---|
| Group arrives | Day ~2–3 (Sept 7–8) |
| *Pacific Tender* anchors | Day ~9–10 (Sept 14–15) |
| Grace's non-displaced fibula fracture heals | ~6–8 weeks from injury → ~Oct 16–Nov 2 `[SRC]` Cleveland Clinic and others; injury date ≈ Sept 4–5 |
| Return to running/sport | ~3–4 months → ~Dec–Jan `[SRC]` |
| "At least a couple of months" | → through **at least early-to-mid November** |
| Alpharetta's nuclear danger window (irrelevant here) | ~Sept 15–27 `[DERIVED]` |
| Winter solstice, Port Angeles | Dec 21: **8 h 21 m** daylight (longest day 16 h 07 m) `[SRC]` timeanddate.com |

The stay runs **out of the good-solar season and into the storm season**. That is the design constraint behind §5–§7.

---

## 3. Port Angeles Harbor: open items resolved

### 3.1 Non-anchorage area — RESOLVED `[SRC]`

**33 CFR 110.230**, Port Angeles Harbor: a single **non-anchorage area** (no vessel may anchor "at any time"; transit by the most direct route only; no dragging, seining or fishing that might foul underwater installations). The boundary, from the regulation's text:

| Point | Regulation (DMS) | Decimal |
|---|---|---|
| Start, on shore | 48°07′03.83″N, 123°24′20.67″W | 48.1177°N, 123.4057°W |
| 2 | 48°07′38.43″N, 123°24′04.67″W | 48.1273°N, 123.4013°W |
| 3 | 48°07′36.03″N, 123°23′50.67″W | 48.1267°N, 123.3974°W |
| 4, on shore | 48°06′56.73″N, 123°24′08.67″W | 48.1158°N, 123.4024°W |

It is a small nearshore box at the **southeast corner of the harbor**, ~0.8–1.4 nm south of Ediz Hook Light (the shape of an underwater-installation protection zone; the city marks it with shoreline signs). **The suggested anchor position (48.1300°N, 123.4170°W) is ~0.65 nm west-northwest of the nearest corner — outside it.** `[DERIVED]`

Other constraints from the Coast Pilot `[SRC]`: log booming grounds in the north part, extending more than 1 nm from the west shore (harbor ~2.5 nm long → booming grounds roughly west of about 123.44°W; the anchor position is ~1 nm east of that `[DERIVED]`); a 5-fathom rock at 48°07′22″N, 123°13′18″W **(this longitude is ~10 nm east of Ediz Hook Light — appears to be a typo in the Coast Pilot text or a different feature; ignore for this harbor, `[VERIFY]`)**; deadheads/sinkers inside the Hook; Puget Sound VTS asks for notification before anchoring.

### 3.2 Bridge-remote anchor release — RESOLVED (mostly) `[SRC]`

Sources: Wikipedia, *Anchor windlass*; seamanship references (theseafarer.com, knowledgeofsea.com):

- A bridge-mounted remote for the windlass exists, but "it is **not normally possible to operate a windlass, in a safe manner, entirely from the bridge**": windlasses need a chain stopper to absorb load and a safety cable/pin to prevent accidental release.
...
## 5. Requirements for the group's lodging

From the author's brief plus consequences:
...
### 6.1 The orbital geometry `[SRC]` + `[DERIVED]`

- The ISS orbits at ~51.6° inclination, ~400 km up `[VERIFY]`. Its ground track **spends the most time near its northern and southern limits** (~51.6°). Observers at 45–50°N — Port Angeles is at ~48.1°N — get **many passes, often high in the sky**, either just north or just south of the site, always moving west to east.
- **This corrects an earlier note of mine** in `research-compendium.md` §3.7, which said passes at ~48°N run lower than farther south. It is close to the opposite: passes are frequent and often high; what matters is a low horizon **in every direction**, because a pass can arrive in the northern or southern sky.
- Visual spotting needs the ISS in sunlight while the observer is in twilight or dark (dawn/dusk passes) `[SRC]` ham doc.
- The ham doc's rule for radio: passes above ~30° give the longest, cleanest contact; below ~20° buildings and terrain often block it entirely `[SRC]`.

### 6.2 Terrain `[DERIVED]` — angles are estimates; check on a topo map `[VERIFY]`

| Site type | Sky assessment |
|---|---|
| **Elwha valley (Grace's house, 48.04°N)** | Enclosed by foothills and ridges close on the south and west — likely a high horizon, poor. (Unlike Mount Angeles, the valley walls are within a few miles.) |
| **Port Angeles waterfront / hillside** | North: open water (Strait). South: **Mount Angeles (~6,450 ft) ~8–9 nm away → about 7–8° elevation** — below the ~20° radio threshold and near the ~10° a visual observer would want cleared |
| **Ediz Hook** (flat spit, water on both sides) | Best horizon on the harbor: water north and south. Mount Angeles ~9 nm south, ~7° |
| **Sequim / Dungeness Valley** (flat prairie, ~17 mi east) | Olympics front 10–20 mi south → ~4–7°; **driest, sunniest ground on the peninsula** (§7). Very open sky |
| **Lake Crescent Lodge / Sol Duc Hot Springs** (Olympic NP lodges, ~20–30 mi west) | Mountain lake and river valleys with 2,000–4,000 ft walls within a mile or two → 25–35° `[VERIFY]` — poor; the lodges fail R3 |
| **The ship's bridge / monkey island** | ~40 m above the water; horizon limited only by Mount Angeles (~7°) and the Hook. Excellent |

**So R3 alone rules out the Elwha valley and the national-park lodges, and favors the waterfront/Hook, Sequim–Dungeness, and the ship.** Whatever they choose also needs a clear mast or roof location for a VHF/UHF antenna.

---

## 7. Winter clock

### 7.1 Solar `[SRC]` (Washington Solar Authority, TurbineGenerator.org, others; Seattle as a proxy)

- Seattle: ~**1.5–2.2 peak sun hours** in December vs ~**5.5** in July; annual average ~3.7. December output is roughly **25–40% of summer**.
- Off-grid designers in the Pacific Northwest "use solar sized for autumn through spring, with a **propane or diesel generator for the 2–3 worst winter months**."
- **Rain shadow:** Sequim–Dungeness gets ~15 in/yr, Port Angeles low-20s in, Seattle 37–38 in `[SRC]` (Peninsula Daily News; Sequim real-estate/weather sources). Port Angeles is "almost as sunny as Sequim" by the Peninsula Daily News's headline. Sept–Oct on the Strait side are good solar months; November is the pivot.
- Approximate monthly peak sun hours for a Puget Sound–like site: Sept ~3.5–4, Oct ~2–2.5, Nov ~1.3–1.8 `[VERIFY]` (general knowledge; I have not sourced these).

### 7.2 A first-pass load and generation sketch `[DERIVED]`

Nothing here is sourced; it is arithmetic for scoping.

| Item | Estimate |
|---|---|
| A comfortable household of six, **gas/wood for heat and cooking**, electric for fridge/freezer, lights, well pump, laptops, radios, small washer | ~8–12 kWh/day |
| 8 kW of panels at 1.8 peak sun hours, ~80% system efficiency | ~11.5 kWh/day in December (marginal), ~28+ kWh/day in September |
...
## 8. Lodging options compared

All are **proposals**. Real businesses are named only where they are public, national-park concession lodges. Everything is `[DERIVED]` unless tagged. Options are described as archetypes; the author picks or invents the actual place.
...
### 8.1 Recommendation `[DERIVED]`

**A two- or three-node plan, not one place:**
...
**Location `[SRC]`:** Coast Guard Air Station / Sector Field Office Port Angeles, **48°08′27″N, 123°24′39″W (≈ 48.1408°N, 123.4108°W)** (Wikipedia), at the outer end of Ediz Hook, ~0.3 nm west of the Hook's east extremity (NOAA Coast Pilot). Ediz Hook Light (48.1400°N, 123.4025°W) and a 170-ft Coast Guard VTS radar tower (0.1 nm WSW of the light) are beside it; the Coast Guard's radio station (call sign NOW) is at the air station.

**What is there `[SRC]`** (Wikipedia "Coast Guard Air Station Port Angeles"; GlobalSecurity; DVIDS 2018; military.com listing):
...
| **Not documented** | Standby generators, fuel storage (helicopter and boat fuel), galley, shower and laundry facilities, exact bed counts — `[VERIFY]` before writing. Aviation and small-boat stations of this kind normally have standby power and fuel `[DERIVED]`, but the sources do not say |

**Fit against the requirements (§5):**
...
| R5 | Not the crash site | ✓ |
| R6 | Near hospital, harbor, airport | **Harbor: on it.** Anchorage ~0.65 nm SSW — a short boat ride. Hospital (Olympic Medical Center): ~3–4 mi by road `[DERIVED]`. **The Hook has its own airfield, KNOW (runway 8/26, 4,500 × 150 ft — corrected 2026-09-20 after my error)**: the PC-12 can be based at the station. KCLM is an alternate, ~5 mi west by road `[DERIVED]` |
| R7 | Nuclear-safe | ✓ (Kitsap/Bangor is ~40–50 mi east across the water; the station supports Navy submarine escorts — flag, don't dramatize) |
| R8 | Suits a healing fibula | Mostly single-storey working buildings and a level spit; the pier and gangways need care `[DERIVED]` |

**What Catherine and Grace get:** a Coast Guard **medical clinic** and **dental clinic** — a functional place to check and re-cast Grace's leg, and a source of supplies `[VERIFY the clinic's contents]`. Combined with Olympic Medical Center, that gives Catherine two medical sites.

### 8.3 Consequences of the choice
...
### 8.4 The bodies: a big issue (author, 2026-09-20)

**Canon:** dealing with the bodies is a big issue — a central challenge of this phase and a site-selection criterion (`CLAUDE.md` amendment 10). Everything below is planning material; the approach is the author's call (Q-28).

**Scale `[DERIVED]` unless tagged.** Nobody alive nearby; nobody to move the dead.

| Place | Who was there at 2:00 AM Eastern (11:00 PM Pacific), Tue Sept 5 — the night after Labor Day | Rough count |
|---|---|---|
| Coast Guard station | Watchstanders, helicopter and boat alert crews, the Transit Protection System's alert forces, and duty sections on the cutters | **17** (author) |
| Olympic Medical Center | Night staff plus inpatients (67–126 licensed beds `[SRC]` Wikipedia/nursa; sources disagree) | ~100–200 |
| Hotels, B&Bs, campgrounds | **Labor Day holiday travelers — fuller than a normal Monday night**; ferry visitors from Victoria | 5 to 150+ per site |
| An ordinary house | The household | 1–5 |
...
**Health `[SRC]`.** UN, PAHO/WHO and ICRC guidance (the *Management of Dead Bodies after Disasters* field manual): **dead bodies pose no significant epidemic risk**; the agents do not survive long after death. The real hazards are **contaminated water, sanitation failure, and psychological harm**. The manual also stresses **identifying the dead** and dignified handling over mass burial or cremation, and recommends cold storage or temporary organized graves. For the story: the health danger is water and hygiene, not the corpses; the emotional danger is real.

**Options for the group `[DERIVED]`:**
...
| Step | Notes `[DERIVED]` unless tagged |
|---|---|
...
| **Limits** | **Not the way to Italy** (Panama Canal, below) and **cannot carry the BCR trucks** |
...
| Need | What an expedition yacht gives |
|---|---|
...
- **Italy.** The **Panama Canal is closed to them**: its lock gates, valves and towing locomotives run on electric motors, operated from a control house, and every vessel must carry a canal pilot and line handlers `[SRC]` Britannica, Marine Insight, Cruising World. The alternatives are Cape Horn (very long and hard) or the Northwest Passage (open only late summer) `[DERIVED]`. A small yacht is not the way to Italy; **the Italy excursion is most likely by air**, and that leaves the **BCR** trucks unresolved (Q-23): a yacht cannot carry four 13-ft-tall camper trucks, and neither can most airplanes. A roll-on/roll-off car carrier would, but the group has no crew for one.
- **Anything to do with the container ship.** It stays at anchor with no one aboard: **no anchor watch** means winter east-wind dragging risk (§7.3); the 22 dead remain unresolved (Q-28); the ship and its cargo are simply left. That could itself be a scene (a last visit, a dignified goodbye), or the ship could be moved to a berth if tugs existed (they don't).

**Where to find one `[SRC]` / `[DERIVED]`:**

| Source | Distance to the Hook `[DERIVED]` | Notes |
|---|---|---|
| **Port Townsend** (boatyards, Boat Haven) | **~30.5 nm** across the Strait `[SRC]` Savvy Navvy | Closest; 4 h at 8 kt; a boatbuilding and refit town — many long-range cruisers |
| **Port Angeles Boat Haven** and **John Wayne Marina** (Sequim Bay) | 3 nm / ~25 nm | Boats in slips; some live-aboards |
...
**Where she sits:** anchored at ≈ 48.1300°N, 123.4170°W, ~0.65 nm SSW of the Coast Guard station. Port Angeles Harbor is "protected from all except east winds, which occasionally blow during winter" `[SRC]` Coast Pilot; in southeast gales "the wind is not usually felt but some swells roll in."

**Which way she would drift `[DERIVED]`:** in an **east gale** she drags **west** — toward the harbor's west shore, the log booming grounds and the mill and port wharves, about 1.7 nm away. The group's camp on the Hook is **north-east of her, i.e., upwind, and physically safe** in that case. A wind from the north-northeast would push her toward the town waterfront; a south or southwest wind toward the Hook (both are shielded by the mountains and the Hook). **The yacht should not be moored where a dragging ship could reach it.**

**Worst cases, most likely first:**

| # | What happens | Precedent / basis | Consequence |
|---|---|---|---|
| 1 | **Nothing, for a long time** | Laid-up ships sit at anchor for months to years | She rusts; her lights, and her AIS transponder, go dark once the power dies. A landmark and a grave. **Most likely** |
| 2 | **She drags in a winter east gale and grounds** on the soft bottom off the west shore, or strikes wharves | High-windage container ships drag in strong wind; the harbor's bottom is soft and shoals are gentle `[DERIVED]` | Hull damage and a possible fuel leak; a container stack shifts; port infrastructure damaged. The group is upwind |
| 3 | **Containers go overboard** | *Rena* (2011): many containers fell overboard, hazards to shipping, toxins washing up **six years later** `[SRC]` Maritime NZ/TAIC | Floating debris that damages small boats — the **yacht** and the station's boats are at risk. Some cargo is toxic |
| 4 | **Fire** in the containers | Lithium-ion batteries and misdeclared goods are the biggest cause of container-ship fires; "a major container-ship fire occurs roughly every 17 days worldwide" `[SRC]` Motorship/Marine Link; *X-Press Pearl* (2021) burned for nearly two weeks at 1,500 °C with 25 t of nitric acid aboard `[SRC]` | With no one aboard and no firefighting, a fire burns until it is spent — a smoke plume over the harbor for weeks; toxic; can't be stopped. Lower risk than for a crewed ship (no powered reefers, no crew), but lithium thermal runaway needs no power `[DERIVED]` |
| 5 | **Worst: grounded, holed, fuel spill, then breakup** | *Rena* (2011): 236 m, 1,368 containers, **1,733 t of heavy fuel oil**, ~200–350 t spilled, **~50 km of coastline oiled**; she **broke in two after three months**; salvage cost ~$700 million and ran to 2016 `[SRC]` | In a small enclosed harbor, an oil scar on the Hook's beach and the harbor shore for years; no cleanup crews exist. **Unlikely, but this is the worst** |

**Does it matter?** It depends what you want it to do:
...
| Topic | Source |
|---|---|
| Non-anchorage area coordinates | 33 CFR § 110.230 — https://www.law.cornell.edu/cfr/text/33/110.230 |
| Harbor, anchorage, pilotage, Coast Guard station, Ediz Hook Light | NOAA *U.S. Coast Pilot 10*, Ch. 7 (13 Sep 2026 edition) — https://nauticalcharts.noaa.gov/publications/coast-pilot/files/cp10/CPB10_C07_WEB.pdf |
| Anchor windlass and anchoring practice | Wikipedia "Anchor windlass"; theseafarer.com "Anchoring Procedures"; knowledgeofsea.com "Anchoring Methods" |
| Rescue-boat / lifeboat davits (gravity or stored power) | Lloyd's Register Class News 17/2023 — https://www.lr.org/en/knowledge/class-news/17-23/ ; Marine Insight; Fountom |
| Container-ship hotel-mode fuel burn | transportgeography.org; maritimepage.com; *Scientific Reports* 2022 (transpacific crossing energy study) |
| Yokohama–Seattle distance/transit | fluentcargo.com; visiwise.co; SeaRates |
| Solar peak sun hours, winter output | washingtonsolarauthority.com; turbinegenerator.org/seattle |
| Sequim/Port Angeles rain shadow, sunshine | Peninsula Daily News "Port Angeles almost as sunny as Sequim"; Emerald City Weather; Sequim real-estate weather blogs |
| Daylight, Port Angeles | timeanddate.com/sun/usa/port-angeles |
| Fibula fracture healing | Cleveland Clinic; other orthopedic sources |
| Crash-site hazards | DTIC ADA400075 (composite hazards at crash sites); aviationinvestigation.com "Hazards at the Accident Site" |
| Lodging types near Port Angeles/Sequim | Hipcamp, Vacasa and vacation-rental listings (category evidence only; no specific listing relied on) |
| Coast Guard station facilities, coordinates, housing | Wikipedia "Coast Guard Air Station Port Angeles" (48°08′27″N 123°24′39″W; no on-base housing); GlobalSecurity "Air Station Port Angeles"; DVIDS "Transit Protection System Construction at Port Angeles' Ediz Hook Concludes" (Sept 2018); military.com base guide (Sector Field Office Port Angeles) |
| Airfield KNOW (runway, fuel, restrictions) | AirNav — https://www.airnav.com/airport/KNOW (runway 8/26, 4,500 × 150 ft asphalt; JP-8 for SAR/CG only; 24-hr PPR) |
| Dead bodies: health risk and handling | UN News (2006) "Dead bodies in natural disasters pose negligible epidemics threat"; PAHO/WHO "Risk of dead bodies associated with an epidemic"; ICRC/PAHO/WHO/IFRC *Management of Dead Bodies after Disasters: A Field Manual for First Responders* |
| Decomposition timeline | Spaulding Decon, Florida Emergency Cleaning, Valor Technical Cleaning, ScienceInsights, and a PMC study (Cfb-climate VOC profile) — **general/approximate** |
| Keepers' quarters | newdungenesslighthouse.com (the keeper's quarters, keeper program, packet); USLHS history |
| Retreat centre | Washington State Parks — Ramblewood Retreat Center |
| RV dealers on the peninsula | rvcountry.com — the Sequim location page (261293 US-101; hours) and the listing for the 2027 Thor Motor Coach Inception 38DX, stock #47492 (Mesa, AZ) — https://rvcountry.com/inventory/2027-thor-motor-coach-inception-47492 ; RV Insider; Yelp (older name "Clear Creek RV Center"); wilderrvs.com (Port Angeles); Nominatim/OSM (261293 US-101 → 48.0799°N, 123.1717°W) |
| Hood Canal Bridge | WSDOT "Hood Canal Bridge" and "common questions"; Wikipedia |
| Port Angeles municipal water | City of Port Angeles Water Utility; NPS (Port Angeles Water Treatment Plant); Peninsula Daily News (Elwha water facility) |
| Campgrounds and RV parks | Clallam County (Salt Creek, Dungeness Recreation Area); The Dyrt; Hipcamp; Campendium; RVezy/RVshare listings |
| Expedition yachts | Yachting ("Kadey-Krogen announces 64- and 68-foot expedition models"; "Boat Review: Kadey-Krogen 55 Expedition"); Nordhavn.com (N60, N80, Northwest sales and service hub in Anacortes); BoatTEST and Passagemaker (Nordhavn 60) |
| Port Townsend – Port Angeles passage | Savvy Navvy route data (~30.5 nm) |
| Panama Canal operations | Britannica ("Panama Canal — Locks"); Marine Insight; Cruising World; the Canal Authority's lock design page |
| Container-ship casualties | Maritime NZ / TAIC / ITOPF / Wikipedia (MV *Rena*, 2011); Wikipedia / Pulitzer Center / OSRL (*X-Press Pearl*, 2021); Motorship, Marine Link, Advanced Maritime Technology International (lithium-ion battery fires) |
| 100–120 ft yachts (crew, fuel, range) | Dockwalk and Yachttrading ("What size yacht requires a crew"); Lengers Yachts; Fraser Yachts; Seattle Yachts expedition-yacht FAQ |
| Ballard Locks | Wikipedia "Ballard Locks"; Seattle Times; Cascade PBS (trained operators; two chambers to 760 × 80 ft; 24/7) |
| Anchorage / station distances | NOAA Coast Pilot 10, Ch. 7 (station ~0.3 nm west of the Hook's east extremity; VTS tower 0.1 nm WSW of the light) |
