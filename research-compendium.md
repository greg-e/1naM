...
| **Grace** | 32 | Near Elwha, WA (Olympic Peninsula) — *moved from Portland, OR by the 2026-09-20 retcon; prose not yet updated (D-15)* | Diesel mechanic + electrical engineer; installed her own solar+battery | Full member (fibula in cast) | Rescued §8 |
...
- **Career arc:** gliders and Cessnas as a teenager → flight-instructor rating through college → ratings added "for twenty-five years" → **8 years C-17 Globemasters, USAF** (not C-130) → **2 years corporate/charter jets out of Atlanta** (why he knows the Signature ramp) → **~10 years at Delta**, now **Captain, Airbus A350-900**. Entirely fixed-wing; **not rotary-rated and would never consider flying a helicopter.** His C-17 history is backstory only and does not reintroduce a C-17 as a group asset.
...
> **Amended 2026-09-20 (author): her house is no longer suitable because of the accident** (read as the airliner crash near her home — confirm, Q-16 in `port-angeles-base-research.md`). The group cannot stay there; her skills and possibly her solar+battery gear carry over. Because the house is inland (~7 mi from the shore), **the rescue site is proposed to move to the Elwha River near the wreck** — she could not have reached the Strait shoreline on a broken fibula (`CLAUDE.md`, further amendment 2). Sections 8 and 10's house scenes need a new setting (D-18).

- **Home address (author-supplied 2026-09-20): 217 Wapiti Way, Port Angeles, WA 98363.** **The author's Google Maps pin (48.0435°N, 123.5980°W) puts it inland** — roughly 7 mi south of the Elwha River mouth / Strait shoreline and ~9 mi SW of downtown Port Angeles, forested foothill country toward Olympic National Park `[DERIVED]`. So the prose's "coastal house" is wrong post-retcon (D-15): no ocean view; rescue site (shoreline) and house are ~7 mi apart; hospital drive ~15–20 min `[DERIVED, VERIFY]`. Inland/rural also makes her solar+battery system more natural. **Caution:** the pin for this address is a real vacation-rental business — don't name it in prose; consider fictionalizing the street address before any publication.
- **Age/place:** 32, **near Elwha, WA** — the Elwha River mouth, Olympic Peninsula, a few miles west of Port Angeles on the Strait of Juan de Fuca. **Relocated from Portland, OR by the 2026-09-20 retcon** (`CLAUDE.md` governs; `sections/05`, `08`, `10` still say Portland/Seaside until cleaned up — D-15). Skilled diesel mechanic and electrical engineer.
- **Injury:** Near her home, a long-haul commercial flight went down uncrewed (everyone aboard dead like everyone else). Self-splinted a fibula fracture with driftwood and a torn jacket sleeve; survived three days alone on the coast (prose: the overlook near Seaside/Cannon Beach; post-retcon default: a bluff or beach near the Elwha River mouth / Freshwater Bay). A downed Seattle-bound long-haul airliner near the Strait of Juan de Fuca is plausible, since Asia→Seattle arrivals typically pass over or near the Olympic Peninsula. `[VERIFY]`
- **Discovery:** By the coordinates in her 911 call (§5). **No contact was ever made** — she doesn't know anyone heard it.
- **Function:** Her coastal house has power and hot water via a **solar+battery islanding system she installed herself** after storm outages (§8). In §10 she fixes the well-pump wiring, rebuilds a generator carburetor, and rigs a directional antenna that improves John's satellite hotspot.
...
- **Convergence (§10):** John finds the ship's AIS anchored in Elliott Bay — behavior no autopilot produces. The group decides to go investigate; **not yet met**.
...
Pathology/infectious-disease professor near Milan, Italy. Reintroduced 2026-09-05. A pre-collapse ham operator who reaches the ISS crew independently; the group finds her **through the ISS contact channel**. **2026-09-20: the group ultimately makes an excursion to Italy to connect with her, and TruckHouse's BCRs are needed for it** (`CLAUDE.md`, further amendment 8; logistics open — Q-23 in `port-angeles-base-research.md`). Also indirectly connected to research on the pathogen/survival question. **Do not resolve why people survive** (deliberate mystery; no genetic, antibody, or exposure-survivor theory).
...
- **Open, not yet decided:** who builds/operates the group's own link, and how first contact plays out relative to Tyler joining. Yohan is the leading candidate. *Don't invent this without flagging it.*
- **Not yet on the page:** any actual ham contact scene.
...
**Fleet rule:** whether the PC-12 remains the standing aircraft long-term is **open** — don't assume it's locked in, and don't casually put them in something else without a reason. Previously cut aircraft (C-17, King Air as a group asset, Gulfstream, etc.) shouldn't return without asking.
...
- **Q-08 — ISS crew and return.** Who else is aboard? What is Tyler's mother's mission timeline, and can she come home without ground support? (Consumables and return vehicle are the likely clocks.)
- **Q-09 — TruckHouse.** Does the group go to Reno, and when? The Alpharetta danger window (~Sept 15–27) matters less now that they've left; is there a *new* safety reason to move? **Updated 2026-09-20:** Grace's house is itself very low nuclear risk (§5.9), so *no* safety reason remains — Reno has to be motivated by TruckHouse itself. **Author's stated reasons (2026-09-20): (1) Catherine wants to know what happened to her brother; (2) TruckHouse's BCRs are needed for the excursion to Italy to connect with Dr. Elise Marchetti.** Open: what "BCR" means in the book (the real TruckHouse BCR is a carbon-fibre camper on an AEV Ram 3500 `[VERIFY]`), how many, and how they get to Italy (Q-23).
